...
const STATUS_COLORS: Record<string, string> = {
  ...
  Uninstalled: 'bg-gray-500/10 text-gray-500 border-gray-500/20',
  Superseded: 'bg-blue-500/10 text-blue-500 border-blue-500/20',
  'Pending install': 'bg-yellow-500/10 text-yellow-500 border-yellow-500/20',
